    ...
    if (18 <= yas <= 40)
    {
        ...
        if (mezuniyet == 'Y')
        {
            ...
            if (surucuBelgesi == 'Y')
            {
                ...
                {
                    printf("Tebrikler sarlarimizi karsiliyorsunuz ise alindiniz");
                }
                ...
                {
                    printf("Basvuru sartlarimizi karsilamiyorsuhnuz ama Servis Soforlugu sartlarimizi sagliyorsunuz \nServis Soforu olarak ise baslamak ister misiniz ? (Y/N)");
                    scanf("%c",&cevap1);
                    if(cevap1 == 'Y')
                    {
